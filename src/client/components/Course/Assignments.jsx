...
class Assignment extends Component {
  ...
  renderSendButton(sendInfo) {
    return (
      <div style={{ textAlign:'right' }}>
        ...
        />
        {sendInfo.activateHelp ? this.renderHelp(sendInfo) : ''}
        {!sendInfo.isCorrect && typeof sendInfo.isCorrect === 'boolean' && sendInfo.activateHints ? this.renderHint(sendInfo) : ''}
      </div>
    ...
    return (
        <RaisedButton 
          ...
          onClick={() => { this.setState({
            openHelp: true,
            helpDialogContent: item.helpContent
          }) }}
  ...
  renderDialog() {
    const closeDialogButton = <RaisedButton 
    ...
    return (
      <Dialog 
        ...
        open={this.state.openHelp || this.state.openHint}
        onRequestClose={() => this.setState({ openHelp: false })}
        autoScrollBodyContent={true}
        bodyStyle={{ paddingTop: '20px' }}
      >
        <div dangerouslySetInnerHTML={{__html: this.state.helpDialogContent}}/>
      </Dialog>
    );
  }
